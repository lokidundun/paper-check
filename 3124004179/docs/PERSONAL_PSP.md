...
| ----------------------------- | ---------------------- | -------: | -------: |
| Planning / Estimate           | 确定本轮复现目标和时间安排          |       15 |       15 |
| Development / Analysis        | 阅读要求，理解输入输出、余弦相似度和算法限制 |       20 |       30 |
...
| Development / Design          | 设计补充样例或有实际需要的改进        |       25 |       25 |
| Development / Coding          | 根据本轮发现的问题完善代码或测试       |       55 |       40 |
